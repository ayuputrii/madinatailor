          ...
          <div class="col-12">
            <div class="card card-chart">
              ...
              <div class="col-md-12">
                ...
                <form method="POST" action="/stok/update/{{$stok->id_stok}}">
                  {{ csrf_field() }}
                  <div class="form-row">
                    <h5 class="my-1 mr-2" for="Code"><p color="black">Code</h5>
                      <div class="col-12">
                        <input type="text" name="kode_barang" class="form-control" value="{{$stok->kode_barang}}" placeholder="Code" required readonly>
                      </div>
                  </div>
                  <div class="form-row">
                    <h5 class="my-1 mr-2" for="Total Of Out"><p color="black">Total Of Out</h5>
                      <div class="col-12">
                        <input type="text" name="id_brgkeluar" class="form-control" value="{{$stok->id_brgkeluar}}" placeholder="Total Of Out" required>
                    </div>
                  </div>
                  <div class="form-row">
                    <h5 class="my-1 mr-2" for="Total Of Incoming"><p color="black">Total Of Incoming</h5>
                      <div class="col-12">
                        <input type="text" name="id_brgmasuk" class="form-control" value="{{$stok->id_brgmasuk}}" placeholder="Total Of Incoming" required>
                      </div>
                      </div>
                      <div class="form-row">
                        <h5 class="my-1 mr-2" for="Total Goods"><p color="black">Total Goods</h5>
                        <div class="col-12">
                          <input type="number" name="total_barang" class="form-control" value="{{$stok->total_barang}}" placeholder="Total Goods" required>
                        </div>
                      </div>
                      <div class="form-row">
                        <h5 class="my-1 mr-2" for="Information"><p color="black">Information</h5>
                        <div class="col-12">
                          <textarea name="keterangan" class="form-control" placeholder="Information" alue="{{$stok->keterangan}}" required></textarea>
                        </div>
                      </div>
