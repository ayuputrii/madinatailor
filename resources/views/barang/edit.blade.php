          ...
          <div class="col-12">
            <div class="card card-chart">
              ...
              <div class="col-md-12">
                ...
                <form method="POST" action="/barang/update/{{$brg->kode_barang}}">
                  {{ csrf_field() }}
                  <div class="form-row">
                    <h5 class="my-1 mr-2" for="Code"><p color="black">Code</h5>
                      <div class="col-12">
                        <input type="text" name="kode_barang" value="{{$brg->kode_barang}}" class="form-control" placeholder="Code" required readonly>
                      </div>
                  </div>
                  <div class="form-row">
                    <h5 class="my-1 mr-2" for="Name"><p color="black">Name</h5>
                      <div class="col-12">
                        <input type="text" name="nama_barang" value="{{$brg->nama_barang}}" class="form-control" placeholder="Name" required>
                      </div>
                  </div>
                  <div class="form-row">
                    <h5 class="my-1 mr-2" for="Spesifikasi"><p color="black">Spesifikasi</h5>
                      <div class="col-12">
                        <input type="text" name="spesifikasi" value="{{$brg->spesifikasi}}" class="form-control" placeholder="Spesifikasi" required>
                    </div>
                  </div>
                  <div class="form-row">
                    <h5 class="my-1 mr-2" for="Location"><p color="black">Location</h5>
                      <div class="col-12">
                        <select name="kode_lokasi" value="{{$brg->kode_lokasi  }}" class="form-control" placeholder="Code Location" required>
                      ...
                      <div class="form-row">
                        <h5 class="my-1 mr-2" for="Category"><p color="black">Category</h5>
                        <div class="col-12">
                            <select name="kode_kategori" value="{{ $brg->kode_kategori }}" class="form-control" placeholder="Code Category" required>
                      ...
                      <div class="form-row">
                        ...
                        <div class="col-12">
                          <input type="number" name="jml_barang" value="{{$brg->jml_barang}}" class="form-control" placeholder="Total" required>
                        </div>
                      </div>
                      <div class="form-row">
                        <h5 class="my-1 mr-2" for="Condition"><p color="black">Condition</h5>
                          <div class="col-12">
                            <select class="form-control" name="kondisi" value="{{$brg->kondisi}}" id="exampleFormControlsumdan" placeholder="Condition" required>
                      ...
                      <div class="form-row">
                        ...
                        <div class="col-12">
                          <input type="number" name="jenis_barang" value="{{$brg->jenis_barang}}" class="form-control" placeholder="List" required>
                        </div>
                      </div>
                      <div class="form-row">
