      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">Borrow Goods</a>
          </div>
          ...
          <div class="col-12">
            <div class="card card-chart">
              ...
              <div class="col-md-12">
                ...
                <form method="POST" action="/pinjambarang/update/{{$pinjambarang->no_pinjam}}">
                  {{ csrf_field() }}
                      <div class="form-row">
                        <h5 class="my-1 mr-2" for="Number"><p color="black"> Number </h5>
                          <div class="col-12">
                            <input type="text" name="no_pinjam" class="form-control" value="{{$pinjambarang->no_pinjam}}" placeholder="Number" required readonly>
                          </div>
                      </div>
                      <div class="form-row">
                        <h5 class="my-1 mr-2" for="Date Of Goods"><p color="black">Date Of Goods</h5>
                          <div class="col-12">
                            <input type="date" name="tgl_pinjam" class="form-control" value="{{$pinjambarang->tgl_pinjam}}" placeholder="Date Of Goods" required>
                          </div>
                      </div>
                      <div class="form-row">
                      ...
                      <div class="form-row">
                        <h5 class="my-1 mr-2" for="Total Borrow"><p color="black">Total Borrow</h5>
                          <div class="col-12">
                            <input type="text" name="jml_pinjaman" class="form-control" value="{{$pinjambarang->jml_pinjaman}}" placeholder="Total Borrow" required>
                          </div>
                      </div>
                      <div class="form-row">
                        <h5 class="my-1 mr-2" for="Borrowing"><p color="black">Borrowing</h5>
                          <div class="col-12">
                            <input type="text" name="peminjaman" class="form-control" value="{{$pinjambarang->peminjaman}}" placeholder="Borrowing" required>
                          </div>
                      </div>
                      <div class="form-row">
                        <h5 class="my-1 mr-2" for="Date Of Out"><p color="black">Date Of Out</h5>
                          <div class="col-12">
                            <input type="date" name="tgl_kembali" class="form-control" value="{{$pinjambarang->tgl_kembali}}" placeholder="Date Of Out" required>
                          </div$pinjambarang
                      </div>
                      <div class="form-row">
                        <h5 class="my-1 mr-2" for="Information"><p color="black">Information</h5>
                          <div class="col-12">
                            <textarea name="keterangan" class="form-control" value="{{$pinjambarang->keterangan}}" placeholder="Information" required></textarea>
                          </div>
                      </div>
