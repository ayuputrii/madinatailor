      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">Incoming Inventory</a>
          </div>
          ...
          <div class="col-12">
            <div class="card card-chart">
              ...
              <div class="col-md-12">
                ...
                <form method="POST" action="/barangmasuk/update/{{$barangmasuk->kode_barang}}">
                  {{ csrf_field() }}
                  <div class="form-row">
                    <h5 class="my-1 mr-2" for="Name"><p color="black">Name</h5>
                      <div class="col-12">
                        <select name="kode_barang" class="form-control" value="{{$barangmasuk->kode_barang}}" placeholder="Code" required>
                  ...
                  <div class="form-row">
                    <h5 class="my-1 mr-2" for="Date Of Incoming"><p color="black">Date Of Incoming</h5>
                      <div class="col-12">
                        <input type="text" name="tgl_masuk" value="{{$barangmasuk->tgl_masuk}}" class="form-control" placeholder="Date Of Incoming" required>
                    </div>
                  </div>
                  <div class="form-row">
                    <h5 class="my-1 mr-2" for="Total Incoming"><p color="black">Total In Incoming</h5>
                      <div class="col-12">
                          <input type="number" name="jml_brg_masuk" value="{{$barangmasuk->jml_brg_masuk}}" class="form-control" placeholder="Total In Incoming" required>
                    </div>
                  </div>
                  <div class="form-row">
                    <h5 class="my-1 mr-2" for="Name Supplier"><p color="black">Name Supplier</h5>
                      <select name="kode_supplier" class="form-control" value="{{$barangmasuk->kode_supplier}}" placeholder="Code" required>
